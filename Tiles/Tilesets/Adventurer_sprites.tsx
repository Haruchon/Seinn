...
<tileset version="1.2" tiledversion="1.3.1" name="Adventurer_sprites" tilewidth="16" tileheight="16" tilecount="832" columns="26">
 <image source="../Sprites/Adventurer Sprite Sheet v1.1.png" width="416" height="512"/>
 <tile id="0">
  <animation>
